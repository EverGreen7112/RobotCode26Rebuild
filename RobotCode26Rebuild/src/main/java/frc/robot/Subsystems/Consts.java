...
public interface Consts {
    ...
    public interface SwerveConsts {
        ...
        public static final double GYRO_DIRECTION = -1; // decide the direction of the gyro(counter clock wise should be
                                                        // positive)
        ...
        // encoders
        public static final EverSparkInternalEncoder TL_DRIVE_ENCODER = new EverSparkInternalEncoder(TL_DRIVE_MOTOR),
        ...
        public static final EverSparkInternalEncoder TL_STEER_ENCODER = new EverSparkInternalEncoder(TL_STEER_MOTOR),
        ...
        public static void config() {
            ...
            MODULES[0] = new SwerveModule(SwerveConsts.TL_VELOCITY_CONTROLLER, SwerveConsts.TL_DRIVE_MOTOR,
                    SwerveConsts.TL_DRIVE_ENCODER, SwerveConsts.TL_ANGLE_CONTROLLER, SwerveConsts.TL_STEER_MOTOR,
            ...
            MODULES[1] = new SwerveModule(SwerveConsts.TR_VELOCITY_CONTROLLER, SwerveConsts.TR_DRIVE_MOTOR,
                    SwerveConsts.TR_DRIVE_ENCODER, SwerveConsts.TR_ANGLE_CONTROLLER, SwerveConsts.TR_STEER_MOTOR,
            ...
            MODULES[2] = new SwerveModule(SwerveConsts.DL_VELOCITY_CONTROLLER, SwerveConsts.DL_DRIVE_MOTOR,
                    SwerveConsts.DL_DRIVE_ENCODER, SwerveConsts.DL_ANGLE_CONTROLLER, SwerveConsts.DL_STEER_MOTOR,
            ...
            MODULES[3] = new SwerveModule(SwerveConsts.DR_VELOCITY_CONTROLLER, SwerveConsts.DR_DRIVE_MOTOR,
                    SwerveConsts.DR_DRIVE_ENCODER, SwerveConsts.DR_ANGLE_CONTROLLER, SwerveConsts.DR_STEER_MOTOR,
    ...
    public interface ShooterConsts {
        ...
        WHEEL_RADIUS = 0, // change this for the real radius of the shooter wheel (in meters)
                ...
                SHOOTING_HEIGHT = HUB_HEIGHT - MECHANISM_HEIGHT, // change this for the real hight of the hub (in
                                                                 // meters)
        ...
        // ball v0
        public static final double[] BALL_V0_DATA = { 0, 0, 0, 0, 0 }; // change this for the real data of the initial
                                                                       // velocity of the ball(in m/s)
        public static final double[] SHOOTER_SPEED = { 0, 0, 0, 0, 0 }; // change this for the real data of the Shooter
                                                                        // speed (in m/s)
        ...
        public static void config() {
            ...
            SHOOTING_ENCODER.setVelConversionFactor((2 * Math.PI * WHEEL_RADIUS) / (SHOOTING_GEAR_RATIO * 60)); // convert
                                                                                                                // from
                                                                                                                // rpm
                                                                                                                // to
                                                                                                                // m/s
